...
export interface ApiEmpandaEmpanda extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descuentoMedia: Schema.Attribute.Integer;
    docena: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::empanda.empanda'
...
export interface ApiPizzaAdicionalPizzaAdicional
  extends Struct.SingleTypeSchema {
  collectionName: 'pizza_adicionals';
  info: {
    displayName: 'pizza adicional';
    pluralName: 'pizza-adicionals';
    singularName: 'pizza-adicional';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPlatoDelDiaPlatoDelDia extends Struct.CollectionTypeSchema {
  collectionName: 'plato_del_dias';
  info: {
    displayName: 'Plato del dia';
    pluralName: 'plato-del-dias';
    singularName: 'plato-del-dia';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    precio: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    salsa: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    slug: Schema.Attribute.UID<'nombre'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSalsasParaPastaSalsasParaPasta
  extends Struct.CollectionTypeSchema {
  collectionName: 'salsas_para_pastas';
  info: {
    displayName: 'Salsas para pasta';
    pluralName: 'salsas-para-pastas';
    singularName: 'salsas-para-pasta';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSalsasParaPlatoSalsasParaPlato
  extends Struct.CollectionTypeSchema {
  collectionName: 'salsas_para_platoes';
  info: {
    displayName: 'Salsas para plato';
    pluralName: 'salsas-para-platoes';
    singularName: 'salsas-para-plato';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::salsas-para-pasta.salsas-para-pasta': ApiSalsasParaPastaSalsasParaPasta;
      'api::salsas-para-plato.salsas-para-plato': ApiSalsasParaPlatoSalsasParaPlato;
